...
OUTPUT_FILE="embedded-workbench.txt"
SCRIPT_NAME="project_dump.sh"

# Folders and patterns to ignore
IGNORE_DIRS=("_project_template" "node_modules" ".pio" "__pycache__" ".git" "envName" ".mypy_cache" ".pytest_cache" "dist" "build" ".next" ".venv"  ".env" "package-lock.json" "bitcoin-30.2")
