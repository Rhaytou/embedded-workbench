...
/*
    ...
    Steps to run:
        1. copy the code into the main.cpp file in the workspace/stm32/src folder
        2. make hpfb_build REF=stm32
        3. make hpfb_upload REF=stm32
        4. make hpfb_monitor REF=stm32
*/
